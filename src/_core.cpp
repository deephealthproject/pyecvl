...
#include <image_ext.h>
#include <imagefuncholder_addons.h>
#include <iterator>
#include <memory>
#include <sstream> // __str__
#include <string>
...
;
	...
	{ // ecvl::View_int16 file:image_ext.h line:9
	...
	{ // ecvl::ImageFuncHolder file:image_ext.h line:14
		pybind11::class_<ecvl::ImageFuncHolder, std::shared_ptr<ecvl::ImageFuncHolder>> cl(M("ecvl"), "ImageFuncHolder", "");
		pybind11::handle cl_type = cl;

		cl.def( pybind11::init( [](){ return new ecvl::ImageFuncHolder(); } ) );

		imagefuncholder_addons(cl);
	}
}
